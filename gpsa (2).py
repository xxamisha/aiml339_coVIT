...
class GPSA(nn.Module):
    ...
    def __init__(
        ...
        # Default 1.0 -> sigmoid ~ 0.73, biased toward positional
        # attention (as in the reference implementation) — a large initial
        # disruption to a PRETRAINED backbone's content-based attention.
        # gating_init=0.0 -> sigmoid = 0.5 (balanced start, less disruptive,
        # useful when fine-tuning a pretrained model for few epochs).
